...
Fibonacci's numbers using the same tasks. I've implemented a recursive function that splits the range by half, where the base occurence(the final stage of the recursion) is when the range is less than 0.01. After that, using a for loop I sum up the results
